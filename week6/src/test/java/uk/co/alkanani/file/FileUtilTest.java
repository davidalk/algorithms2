...
public class FileUtilTest {
    ...
    public void clausesLoadCorrectly() {
        ...
        clauses[1] = new TwoSatClause(-1, 3);
        clauses[2] = new TwoSatClause(2, 1);
        clauses[3] = new TwoSatClause(-5, -4);
        clauses[4] = new TwoSatClause(2, 4);
        clauses[5] = new TwoSatClause(-3, 2);
